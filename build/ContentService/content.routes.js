...
const schemas = __importStar(require("./content.schemas"));
const controllers = __importStar(require("./content.controller"));
async function ContentRoutes(server, options) {
    server.route({
        method: "POST",
        url: "/journal",
